...
def main():
    ...
    """
    pc for Feminelle v1.0
    Generate test cases for addin new position for feminelle.com.ua
    """
    # product classes
    product_clasifier = {}
    with open("types.csv", 'r') as types:
        for t in types:
            key, val = t.split(';')
            ...
            for row in all_records:
                ...
                with open("article_" + article + ".html", 'w') as test_case:
                    ...
                    for photo in photos:
                        ...
                        '\t<td>D:\\GEorGE\\work\other\\feminelle.com.ua\\Feminelle\\{photo_name}.jpg</td>\n'+\
                        '</tr>\n').format(counter=photo_counter, photo_name = photo[:7] + ' ' + photo[-3:])
                        photo_counter += 1
